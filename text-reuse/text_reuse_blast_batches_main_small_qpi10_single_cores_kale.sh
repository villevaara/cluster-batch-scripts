...
echo "----------------------------------------------------------------------" 
echo "SINGLE job cores:$1 iter:$2 timelim:$SBATCH_TIMELIMIT qpi:10"
echo "----------------------------------------------------------------------" 

srun python blast_batches.py --output_folder="$WRKDIR/txt_reuse/blast_work_from_puhti/blast_work" --batch_folder="$WRKDIR/txt_reuse/results_qpi10" --threads=$1 --text_count=1302141 --qpi=10 --iter=$2 --e_value=0.000000001
