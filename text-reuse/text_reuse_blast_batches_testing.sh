...
echo "----------------------------------------------------------------------------" 
echo "SINGLE job cores:$1 iter:$2 timelim:$SBATCH_TIMELIMIT max_target_seqs:$3"
echo "----------------------------------------------------------------------------" 
...
srun python blast_batches.py --output_folder="$LOCAL_SCRATCH/blast_work" --batch_folder="/scratch/project_2000230/txt_reuse/results_testing_$3" --threads=$1 --text_count=1302141 --qpi=10 --iter=$2 --e_value=0.000000001 --max_target_seqs=$3
