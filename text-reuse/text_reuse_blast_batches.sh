...
srun python blast_batches.py  --output_folder="/scratch/project_2000230/txt_reuse/blast_work/" --batch_folder="/scratch/project_2000230/txt_reuse/blast_work/data_out" --threads=4 --text_count=5203431 --qpi=100 --iter=0 --e_value=0.000000001
