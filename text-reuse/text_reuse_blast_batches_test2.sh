...
srun python blast_batches.py --output_folder="$LOCAL_SCRATCH/blast_work" --batch_folder="$LOCAL_SCRATCH/blast_work/data_out" --threads=20 --text_count=5203431 --qpi=100 --iter=0 --e_value=0.00000000001
echo "BLAST CONF: --threads=20 --text_count=5203431 --qpi=100 --iter=0 --e_value=0.00000000001"
...
mkdir set2
scp -r $LOCAL_SCRATCH/blast_work/data_out /scratch/project_2000230/txt_reuse/blast_work_full_testsets_results/set2
