...
#SBATCH --mem=20G
#SBATCH --output=logs/tr_data_final_%j_i$1.out
#SBATCH --error=logs/err/tr_data_final_%j_i$1.err
...
srun python generate_json_multiprocess_lmdb.py --datadir "/scratch/project_2000230/txt_reuse/results_qpi100_remainder" --outdir "/scratch/project_2000230/txt_reuse/results_qpi100_remainder_filled" --threads ${SLURM_CPUS_PER_TASK} --db "$LOCAL_SCRATCH/blast_work/db/original_data_DB" --iter $1
