...
mv /scratch/project_2000230/txt_reuse/blast_work_full_testsets/set1/* $LOCAL_SCRATCH/blast_work/
...
mv $LOCAL_SCRATCH/blast_work/* /scratch/project_2000230/txt_reuse/blast_work_full_testsets/set1/
