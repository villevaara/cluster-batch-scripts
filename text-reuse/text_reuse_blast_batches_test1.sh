#!/bin/bash
#SBATCH --job-name=TR_i46017_e-9_qpi100
...
srun python blast_batches.py --output_folder="$LOCAL_SCRATCH/blast_work" --batch_folder="$LOCAL_SCRATCH/blast_work/data_out" --threads=40 --text_count=5203431 --qpi=100 --iter=46017 --e_value=0.000000001
