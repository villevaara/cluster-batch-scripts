#!/bin/bash
#SBATCH --job-name=TR_e-9_qpi1000_t20_i0
...
srun python blast_batches.py --output_folder="$LOCAL_SCRATCH/blast_work" --batch_folder="$LOCAL_SCRATCH/blast_work/data_out" --threads=20 --text_count=5203431 --qpi=1000 --iter=0 --e_value=0.000000001
