...
srun python blast_batches.py --output_folder="$LOCAL_SCRATCH/blast_work" --batch_folder="$LOCAL_SCRATCH/blast_work/data_out" --threads=10 --text_count=5203431 --qpi=1000 --iter=4800 --e_value=0.000000001
